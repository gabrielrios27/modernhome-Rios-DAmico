El proyecto es un Ecommerce para el negocio de mi familia, en el cual vendemos pisos y revestimientos. Ya contamos con una página web ModernHome-Allentiac en donde solo se muestran los productos.
